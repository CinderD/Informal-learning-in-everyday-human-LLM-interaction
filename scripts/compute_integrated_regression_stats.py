...
LEVEL2 = {
    "WC coding": (
        "WildChat",
        "coding",
        prod_path("0410_wildchat_userturn_pipeline/latest/coding/wildchat_coding_level2/level2_reports/level2_metrics_20260411_212300.csv"),
    ),
    "LMSYS coding": (
        "LMSYS",
        "coding",
        prod_path("0530_lmsys_chat_1m_replacement/user_turn_pipeline_min4/latest/coding/lmsys_coding_level2/level2_reports/level2_metrics_20260624_121538.csv"),
    ),
    "SC coding": (
        "ShareChat",
        "coding",
        prod_path("0529_sharechat_replacement/user_turn_pipeline_min4_english_strict/latest/coding/sharechat_coding_level2/level2_reports/level2_metrics_20260602_125948.csv"),
    ),
    "WC writing": (
        "WildChat",
        "writing",
        prod_path("0410_wildchat_userturn_pipeline/latest/writing/wildchat_writing_level2/level2_reports/level2_metrics_20260411_212539.csv"),
    ),
    "LMSYS writing": (
        "LMSYS",
        "writing",
        prod_path("0530_lmsys_chat_1m_replacement/user_turn_pipeline_min4/latest/writing/lmsys_writing_level2/level2_reports/level2_metrics_20260624_121658.csv"),
    ),
    "SC writing": (
        "ShareChat",
        "writing",
        prod_path("0529_sharechat_replacement/user_turn_pipeline_min4_english_strict/latest/writing/sharechat_writing_level2/level2_reports/level2_metrics_20260602_130002.csv"),
    ),
}
...
LEVEL3_A2U = {
    "WC coding": (
        "WildChat",
        "coding",
        prod_path("0410_wildchat_userturn_pipeline/latest/coding/wildchat_coding_level3/level3_reports/level3_a2u_pairs_20260411_212559.csv"),
    ),
    "LMSYS coding": (
        "LMSYS",
        "coding",
        prod_path("0530_lmsys_chat_1m_replacement/user_turn_pipeline_min4/latest/coding/lmsys_coding_level3/level3_reports/level3_a2u_pairs_20260624_121715.csv"),
    ),
    "SC coding": (
        "ShareChat",
        "coding",
        prod_path("0529_sharechat_replacement/user_turn_pipeline_min4_english_strict/latest/coding/sharechat_coding_level3/level3_reports/level3_a2u_pairs_20260602_130009.csv"),
    ),
    "WC writing": (
        "WildChat",
        "writing",
        prod_path("0410_wildchat_userturn_pipeline/latest/writing/wildchat_writing_level3/level3_reports/level3_a2u_pairs_20260411_212622.csv"),
    ),
    "LMSYS writing": (
        "LMSYS",
        "writing",
        prod_path("0530_lmsys_chat_1m_replacement/user_turn_pipeline_min4/latest/writing/lmsys_writing_level3/level3_reports/level3_a2u_pairs_20260624_121730.csv"),
    ),
    "SC writing": (
        "ShareChat",
        "writing",
        prod_path("0529_sharechat_replacement/user_turn_pipeline_min4_english_strict/latest/writing/sharechat_writing_level3/level3_reports/level3_a2u_pairs_20260602_130016.csv"),
    ),
}
